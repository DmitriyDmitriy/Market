				...
				<div class="row">
					<div class="col-md-3 col-sm-6 col-xs-6">
						<div class="choose-box">
							<img src="images/whychooseus/whychooseus1.jpg" alt="whychooseus1"/>
							...
							<div class="choose-content">
								<span><i><img src="images/whychooseus/choose-ic1.png" alt="whychooseus" /></i></span>
					...
					<div class="col-md-3 col-sm-6 col-xs-6">
						<div class="choose-box">
							<img src="images/whychooseus/whychooseus2.jpg" alt="whychooseus1"/>
							<a href="#" title="Arrow" class="choose-next"><i class="fa fa-long-arrow-right"></i></a>
							...
							<div class="choose-content">
								<span><i><img src="images/whychooseus/choose-ic2.png" alt="whychooseus" /></i></span>
								<h3>Tips &amp; Advice</h3>
								<p>Take a step that is new. We've a loveable spa that needs your face threes company too.</p>	
								<a href="#" class="read-more">Read More</a>
							</div>
					...
					<div class="col-md-3 col-sm-6 col-xs-6">
						<div class="choose-box">
							<img src="images/whychooseus/whychooseus3.jpg" alt="whychooseus1"/>
							<a href="#" title="Arrow" class="choose-next"><i class="fa fa-long-arrow-right"></i></a>
							...
							<div class="choose-content">
								<span><i><img src="images/whychooseus/choose-ic3.png" alt="whychooseus" /></i></span>
					...
					<div class="col-md-3 col-sm-6 col-xs-6">
						<div class="choose-box">
							<img src="images/whychooseus/whychooseus4.jpg" alt="whychooseus1"/>
							<a href="#" title="Arrow" class="choose-next"><i class="fa fa-long-arrow-right"></i></a>
							...
							<div class="choose-content">
								<span><i><img src="images/whychooseus/choose-ic4.png" alt="whychooseus" /></i></span>
		...
		<div class="container-fluid no-padding team-section">
			...
			<div class="container">
				...
				<div class="row">				
					...
					<div class="col-md-3 col-sm-3 col-xs-6">
						<div class="team-box">
							<img src="images/team/team3.jpg" alt="team1"/>
							<div class="team-content">
								<ul>
									<li><a href="#" title="Facebook"><i class="fa fa-facebook"></i></a></li>
									<li><a href="#" title="Twitter"><i class="fa fa-twitter"></i></a></li>
					...
					<div class="col-md-3 col-sm-3 col-xs-6">
						<div class="team-box">
							<img src="images/team/team4.jpg" alt="team1"/>
							<div class="team-content">
								<ul>
									<li><a href="#" title="Facebook"><i class="fa fa-facebook"></i></a></li>
									<li><a href="#" title="Twitter"><i class="fa fa-twitter"></i></a></li>
					...
					<div class="product-carousel">
						<div class="col-md-12">
							<div class="product-block">
								...
								<a href="#" class="product-wish pull-right" title="Add Wish"><i class="fa fa-heart-o"></i></a>
								<div class="product-img-box"><img src="images/product/product1.png" alt="product1"/></div>
								...
								<div class="product-hoverinfo">
									...
									<p><a href="#" title="Add To Wishlist"><i class="fa fa-heart-o"></i>Add To Wishlist</a></p>
								</div>
							</div>
						</div>
						<div class="col-md-12">
							<div class="product-block">
								<span class="new" title="New">New</span>
								<a href="#" class="product-wish pull-right" title="Add Wish"><i class="fa fa-heart-o"></i></a>
								<div class="product-img-box"><img src="images/product/product2.png" alt="product1"/></div>
								<div class="product-info">
									<h4>Fishing line</h4>
									<span>
										<i class="fa fa-star"></i>
						...
						<div class="col-md-12">
							<div class="product-block">
								<span class="sale" title="New">Sale</span>
								<a href="#" class="product-wish pull-right" title="Add Wish"><i class="fa fa-heart-o"></i></a>
								<div class="product-img-box"><img src="images/product/product3.png" alt="product1"/></div>
								<div class="product-info">
									<h4>Fishing reel</h4>
									<span>
										<i class="fa fa-star"></i>
						...
						<div class="col-md-12">
							<div class="product-block">
								<span class="new" title="New">New</span>
								<a href="#" class="product-wish pull-right" title="Add Wish"><i class="fa fa-heart-o"></i></a>
								<div class="product-img-box"><img src="images/product/product4.png" alt="product1"/></div>
								<div class="product-info">
									<h4>Fishing rod</h4>
									<span>
										<i class="fa fa-star"></i>
